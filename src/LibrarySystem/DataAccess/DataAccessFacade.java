...
import LibrarySystem.DataAccess.DataAccessFacade.StorageType;
...
public class DataAccessFacade implements StorageManager {
	enum StorageType {
		AUTHORS, BOOKS, CHECKOUTRECORDS, MEMBERS, USERS;
	}

	public static final String OUTPUT_DIR = System.getProperty("user.dir")
			+ "/src/LibrarySystem/DataAccess/storage/";
	...
	public Map<String, User> readUsersFromStorage() {
		Object users = DataAccessFacade.readFromStorage(StorageType.USERS);
		if (users != null) {
			return (Map<String, User>) users;
		}
		return new HashMap<>();
	}

	public void saveUserToStorage(Map<String, User> users) {
		DataAccessFacade.saveToStorage(StorageType.USERS, users);
	}
